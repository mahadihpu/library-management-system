...
<?php
		if(isset($_POST['submit'])){
			...
			$crud= new crud();
			$rs=$crud->common_select_single('user','*',$data);
			if($rs['success']=="1"){
				if($rs['msg']->status==1){
					if($rs['msg']->active_status==1){
						session_start();
						$_SESSION['id']=$rs['msg']->id;
						$_SESSION['email']=$rs['msg']->email;
						$_SESSION['name']=$rs['msg']->name;
